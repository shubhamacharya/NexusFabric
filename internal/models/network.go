...
type Network struct {
	...
	Images          map[string]string `yaml:"images" json:"images"`            // List of images to be used
	RegistryURL     string            `yaml:"registryURL" json:"registry_URL"` // URL of custom docker registry
